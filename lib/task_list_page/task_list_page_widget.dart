...
class TaskListPageWidget extends StatefulWidget {
  TaskListPageWidget({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final taskListPageUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return InkWell(
                                      onTap: () async {
                                        today_level = await getLevelCall(
                                          levelID: listViewTasksRecord.levelId,
                                        );
                                        await Navigator.push(
                                          context,
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return InkWell(
                                      onTap: () async {
                                        completed_level = await getLevelCall(
                                          levelID: listViewTasksRecord.levelId,
                                        );
                                        await Navigator.push(
                                          context,
